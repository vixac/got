...
func (m *MockEngine) CreateStoreFile() (string, error) {
...
func (e *MockEngine) FetchItemsBelow(lookup *engine.GidLookup, sortStyle int, states []engine.GotState, hideUnderCollapsed bool) (*engine.GotFetchResult, error) {
