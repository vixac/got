...
func TestUnaliasCommand_MissingGID(t *testing.T) {
	...
	cmd := buildUnaliasCommand(mockDeps)
...
func TestUnaliasCommand_Valid(t *testing.T) {
	...
	assert.Equal(t, p.messages[0].Message, "Success: abc is unaliased.")
}

func TestUnaliasommand_ValidButThrows(t *testing.T) {
