...
func TestUnderCommand_MissingArgs(t *testing.T) {
	var p = MockMessenger{}
	var e = MockEngine{}
...
func TestUnderCommand_MissingAlias(t *testing.T) {
	var p = MockMessenger{}
	var e = MockEngine{}
	deps := RootDependencies{
		Printer: &p,
...
func TestUnderCommand_MissingHeading(t *testing.T) {
	var p = MockMessenger{}
	var e = MockEngine{}
	deps := RootDependencies{
		Printer: &p,
...
func TestUnderCommand_CreateBuck_ErrorFromEngine(t *testing.T) {
	var p = MockMessenger{}
	var e = MockEngine{}
