...
func RestoreFromFile(filename string, e engine.GotCreateItemInterface) error {
...
func CreateStoreFile(e engine.GotFetchInterface, longForm engine.LongFormStoreInterface) (string, error) {
	...
	everyLongForm, err := longForm.LongFormForMany(everyId)
	if err != nil {
		return "", err
	}
	...
	codec := &JSONCodec[[]engine.CreateBuckRequest]{}
