...
func NewBulletGidLookup(aliasStore AliasStoreInterface, numberGoStore engine.NumberGoStoreInterface, idGen engine.IdGeneratorInterface) (*BulletGidLookup, error) {
